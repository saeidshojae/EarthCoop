...
class ProjectScopeCutoverRenderer
{
    ...
    public function renderCanonical(
        ...
        $selectedGovernanceValue = $selectedGovernanceAreaId !== null ? (string) $selectedGovernanceAreaId : '';
        ...
        $canonicalPicker = implode("\n", [
            ...
            sprintf('<input type="hidden" name="governance_area_id" value="%s" data-project-governance-area-id>', e($selectedGovernanceValue)),
