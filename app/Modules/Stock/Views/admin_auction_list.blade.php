...
@push('styles')
<style>
    .auction-admin-wrap{direction:rtl;display:grid;gap:1rem}.auction-admin-head{display:flex;justify-content:space-between;gap:1rem;align-items:center;flex-wrap:wrap}.auction-create{border-radius:999px;background:#047857;color:#fff;padding:.75rem 1.1rem;text-decoration:none;font-weight:800}.auction-summary{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:.75rem}.auction-summary>div,.auction-row{background:#fff;border:1px solid #e2e8f0;border-radius:1rem;padding:1rem}.summary-label{font-size:.75rem;color:#64748b}.summary-value{font-size:1.3rem;font-weight:900;color:#0f172a;margin-top:.35rem}.auction-table{display:grid;gap:.75rem}.auction-row-top{display:flex;justify-content:space-between;gap:1rem;align-items:flex-start}.auction-id{font-weight:900;color:#0f172a}.auction-tags{display:flex;gap:.45rem;flex-wrap:wrap;margin-top:.65rem}.auction-tag{font-size:.75rem;padding:.35rem .65rem;border-radius:999px;background:#f1f5f9;color:#475569}.auction-price{font-size:1.15rem;font-weight:900;color:#047857}.auction-meta{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:.75rem;margin-top:1rem}.auction-meta div{font-size:.8rem;color:#64748b}.auction-meta strong{display:block;color:#0f172a;margin-top:.25rem}.auction-links{display:flex;gap:.5rem;flex-wrap:wrap;margin-top:1rem}.auction-links a{border-radius:999px;padding:.55rem .85rem;text-decoration:none;font-weight:700;background:#f1f5f9;color:#334155}.dark .auction-summary>div,.dark .auction-row{background:#0f172a;border-color:#334155}.dark .summary-value,.dark .auction-id,.dark .auction-meta strong{color:#f8fafc}.dark .auction-tag,.dark .auction-links a{background:#1e293b;color:#cbd5e1}@media(max-width:900px){.auction-summary,.auction-meta{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:600px){.auction-summary,.auction-meta{grid-template-columns:1fr}.auction-row-top{flex-direction:column}}
</style>
@endpush
        ...
        @forelse($auctions as $auction)
            <article class="auction-row">
                <div class="auction-row-top">
                    ...
                    <div>
                        <div class="summary-label">قیمت پایه (گل)</div>
                        <div class="auction-price">{{ $fa($auction->base_price_gol ?? 0) }} گل</div>
                        <div class="summary-label">{{ $fa(((int)($auction->base_price_gol ?? 0))/100, 2) }} بهار</div>
                    </div>
                </div>
                ...
                <div class="auction-links">
                    <a href="{{ route('admin.auction.show', $auction) }}">جزئیات</a>
                    @if(in_array($auction->status, ['scheduled']))<a href="{{ route('admin.auction.edit', $auction) }}">ویرایش</a>@endif
                </div>
            </article>
        @empty
            <div class="auction-row text-slate-500">هنوز حراجی ثبت نشده است.</div>
        @endforelse
    </div>
