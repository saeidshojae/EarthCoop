...
return new class extends Migration
{
    ...
    {
        Schema::table('najm_sub_accounts', function (Blueprint $table) {
            if (! Schema::hasColumn('najm_sub_accounts', 'balance_active')) {
                $table->bigInteger('balance_active')->default(0)->after('balance');
            }
            if (! Schema::hasColumn('najm_sub_accounts', 'balance_faded')) {
