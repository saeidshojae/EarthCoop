...
Route::middleware(Authenticate::class)->group(function () {
    ...
    Route::post('/elections/responsibility-offers/{offer}/{decision}', [ResponsibilityOfferController::class, 'respond'])
        ->whereNumber('offer')->whereIn('decision', ['accept', 'decline'])->name('elections.responsibility-offers.respond');
    ...
    Route::middleware(AdminMiddleware::class)->group(function () {
        Route::get('/admin/elections/conflict-policy', [ElectionConflictPolicyController::class, 'index'])
            ->name('admin.elections.conflict-policy.index');
        Route::post('/admin/elections/conflict-policy', [ElectionConflictPolicyController::class, 'store'])
            ->name('admin.elections.conflict-policy.store');
