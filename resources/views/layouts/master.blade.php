...
<!-- Font Awesome -->
    ...
    <!-- Design System - Ù…ØªØºÛŒØ±Ù‡Ø§ Ùˆ Ø§Ø³ØªØ§ÛŒÙ„â€ŒÙ‡Ø§ÛŒ Ù…Ø´ØªØ±Ú© -->
    ...
    <style>
        ...
        /* Edge Browser Compatibility Fixes - Ù‡Ù…Ø§Ù† Ø§ØµÙ„Ø§Ø­Ø§Øª ØµÙØ­Ù‡ welcome */
    ...
    <script>
        ...
        function showAlert(message, type = 'info') {
            ...
            Swal.fire({
                ...
                confirmButtonText: '{{ __("common.ok") ?? "Ø¨Ø§Ø´Ù‡" }}',
