...
<!-- Dark Mode -->
    ...
    <!-- Dark Mode Fix - Ù¾Ø´ØªÛŒØ¨Ø§Ù†ÛŒ Ú©Ø§Ù…Ù„ Ø§Ø² Ú©Ù„Ø§Ø³ dark-mode -->
    ...
    <!-- Unified Styles - Ø¨Ø± Ø§Ø³Ø§Ø³ Ø·Ø±Ø§Ø­ÛŒ Home -->
    ...
    <script>
        ...
        // ØªØ´Ø®ÛŒØµ Edge Ùˆ Ø§Ø¹Ù…Ø§Ù„ ÙÙˆØ±ÛŒ fallback
        ...
        (function() {
            ...
            // Ø¨Ø±Ø§ÛŒ Edge ÙÙˆØ±Ø§Ù‹ base styles Ø±Ø§ Ø§Ø¹Ù…Ø§Ù„ Ú©Ù†
            ...
            // Ø¨Ø±Ø±Ø³ÛŒ Ù„ÙˆØ¯ Ø´Ø¯Ù† Tailwind
            ...
            // Ø¨Ø±Ø±Ø³ÛŒ Ùˆ Ø§ØµÙ„Ø§Ø­ Ø§Ù†Ø¯Ø§Ø²Ù‡â€ŒÙ‡Ø§ Ø¨Ø±Ø§ÛŒ Edge Ø¨Ø¹Ø¯ Ø§Ø² Ù„ÙˆØ¯ ØµÙØ­Ù‡
...
<body class="font-vazirmatn leading-relaxed min-h-screen flex flex-col" 
    ...
    <!-- Unified Header - Ø¨Ø± Ø§Ø³Ø§Ø³ Ø·Ø±Ø§Ø­ÛŒ Home -->
