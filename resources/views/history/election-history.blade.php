...
@section('title', 'تاریخچه انتخابات من - ' . config('app.name', 'EarthCoop'))

@section('content')
<div class="container py-4" dir="rtl" data-election-history-v2>
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-4">
        <div>
            <h1 class="h3 mb-1">تاریخچه انتخابات من</h1>
            <p class="text-muted mb-0">چرخه‌های انتخابات سیستمی شما بر اساس lifecycle واقعی نگهداری می‌شوند؛ رأی، شمارش، پذیرش مسئولیت و انتصاب از یکدیگر تفکیک شده‌اند.</p>
        </div>
        <a href="{{ route('history.election') }}" class="btn btn-outline-secondary">بازگشت به انتخابات جاری</a>
    </div>
