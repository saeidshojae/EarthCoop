...
<style>
    ...
    /* Theme Toggle in Navbar - Enhanced */
    .theme-toggle-navbar {
        position: relative;
        width: 56px;
        height: 30px;
    ...
    .theme-toggle-navbar.dark {
        ...
        border-color: #10b981;
        box-shadow: inset 0 2px 4px rgba(0, 0, 0, 0.2), 0 0 12px rgba(16, 185, 129, 0.3);
    }

    .theme-toggle-navbar.dark:hover {
        box-shadow: inset 0 2px 6px rgba(0, 0, 0, 0.25), 0 0 16px rgba(16, 185, 129, 0.4);
    }
    ...
    .theme-toggle-navbar.dark .theme-toggle-icon.sun {
        opacity: 0.1;
    ...
    .theme-toggle-navbar.dark .theme-toggle-icon.moon {
        opacity: 1;
    }
</style>
    ...
    <div class="container mx-auto">
        <div class="flex justify-between items-center">
            ...
            <div class="hidden lg:flex items-center gap-3">
                ...
                {{-- Language Switcher --}}
                <div class="relative">
                    <button type="button" id="lang-dropdown-btn" class="flex items-center gap-2 bg-white bg-opacity-20 hover:bg-opacity-30 px-3 py-2 rounded-lg transition" aria-label="تغییر زبان">
                    ...
                    <div id="lang-dropdown" class="absolute left-0 mt-2 w-40 bg-white dark:bg-gray-800 rounded-lg shadow-lg hidden z-50">
                ...
                @auth
                    {{-- User Dropdown --}}
                    <div class="relative">
                        <button type="button" id="user-dropdown-btn" class="flex items-center gap-2 bg-white bg-opacity-20 hover:bg-opacity-30 px-4 py-2 rounded-lg transition" aria-label="منوی کاربر">
                            <i class="fas fa-user-circle text-white text-xl"></i>
                            <span class="text-white font-medium">{{ $userName }}</span>
                            <i class="fas fa-chevron-down text-white text-xs"></i>
                        </button>
                        <div id="user-dropdown" class="absolute left-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-lg shadow-lg hidden z-50">
                            ...
                            @endif
                            @if(Route::has('chat-requests.index'))
