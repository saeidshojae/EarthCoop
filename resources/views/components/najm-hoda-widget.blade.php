    ...
    <div id="najm-hoda-chat-container" class="najm-hoda-chat-container" style="display: none !important;">
        ...
        <div class="najm-hoda-header">
            <div class="d-flex align-items-center justify-content-between" style="margin-bottom: 12px;">
                <button id="najm-hoda-close" class="btn-close btn-close-white ms-2" title="بستن"
                ...
                <div class="d-flex align-items-center flex-grow-1" style="min-width: 0;">
                    ...
                    <div class="ms-3" style="min-width: 0; overflow: hidden;">
                        <h6 class="mb-1"
                            style="font-size: 16px; font-weight: 700; letter-spacing: -0.3px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                            نجم‌هدا 🌟</h6>
                        <small class="text-white-50"
                            style="font-size: 12px; display: block; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">دستیار
                            هوشمند ارثکوپ</small>
                    </div>
                </div>
            </div>
        ...
        <div class="najm-hoda-footer">
            <div class="input-group" style="gap: 8px;">
                <input type="text" id="najm-hoda-input" class="form-control" placeholder="پیام خود را بنویسید..."
                    autocomplete="off"
                    style="border: 1.5px solid #dfe8f0; border-radius: 14px; padding: 11px 16px; font-size: 14px; transition: all 0.25s ease; background: #fafbfc;">
                <button id="najm-hoda-send" class="btn btn-primary" type="button"
                    style="border-radius: 14px; padding: 11px 18px; font-weight: 600; transition: all 0.25s cubic-bezier(0.4, 0, 0.2, 1); border: none; background: linear-gradient(135deg, #37c4b4 0%, #459f96 100%); box-shadow: 0 2px 8px rgba(55, 196, 180, 0.25);">
