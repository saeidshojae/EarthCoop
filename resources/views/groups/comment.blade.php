...
<script>
      ...
      commentForm.addEventListener('submit', function(e) {
        ...
        .then(data => {
          ...
          if (data.status === 'success') {
            ...
            // Inject new comment HTML without reload
            ...
            if (data.comment && data.comment.html) {
              ...
              if (commentsList) {
                ...
                tmp.innerHTML = data.comment.html;
                ...
                const newCommentEl = tmp.firstElementChild;
                ...
                if (newCommentEl) {
                  ...
                  // Init reaction buttons for this new comment
                  ...
                  if (typeof window._initCommentReactions === 'function') {
                    ...
                    window._initCommentReactions(newCommentEl);
  ...
  // ===== Polling for new/updated comments every 5 seconds =====
  ...
  (function() {
    ...
    // Calculate initial lastCommentId from DOM
    ...
    document.querySelectorAll('[id^="msg-"]').forEach(function(el) {
      ...
      const cid = parseInt((el.id || '').replace('msg-', ''));
    ...
    setInterval(function() {
      ...
      fetch('/api/comments/' + blogId + '/feed?after_id=' + lastCommentId, {
      ...
      .then(function(data) {
        ...
        if (commentsList && data.comments && data.comments.length) {
          ...
          data.comments.forEach(function(c) {
            ...
            if (!c.html || document.getElementById('msg-' + c.id)) return;
        ...
        if (data.latest_comment_id > lastCommentId) lastCommentId = data.latest_comment_id;
        ...
        if (data.deleted_comment_ids && data.deleted_comment_ids.length) {
          ...
          data.deleted_comment_ids.forEach(function(cid) {
            ...
            const el = document.getElementById('msg-' + cid);
        ...
        // Handle updated comments (reactions changed)
        ...
        if (data.updated_comments && data.updated_comments.length) {
          ...
          data.updated_comments.forEach(function(c) {
            ...
            const existing = document.getElementById('msg-' + c.id);
      ...
      .finally(function() { isPollPending = false; });
