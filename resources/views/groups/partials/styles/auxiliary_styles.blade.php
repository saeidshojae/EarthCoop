...
.group-session-notice{display:flex;align-items:flex-start;gap:12px;width:min(680px,92%);margin:18px auto;padding:16px 18px;border:1px solid #f59e0b;border-radius:18px;background:linear-gradient(135deg,#fffbeb,#fff7ed);box-shadow:0 10px 28px rgba(146,64,14,.1);direction:rtl;color:#78350f}.group-session-notice--ended{border-color:#34d399;background:linear-gradient(135deg,#ecfdf5,#f0fdfa);color:#065f46}.group-session-notice__icon{display:grid;place-items:center;width:38px;height:38px;flex:0 0 38px;border-radius:12px;background:#f59e0b;color:#fff}.group-session-notice--ended .group-session-notice__icon{background:#10b981}.group-session-notice__body{min-width:0;flex:1}.group-session-notice__body strong{display:block;font-size:15px;margin-bottom:5px}.group-session-notice__body p{margin:5px 0;font-size:13px;line-height:1.8}.group-session-notice__body small{display:block;margin-top:7px;opacity:.7}
