...
<div class="w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
        <div class="px-6 py-5 border-b border-gray-100 flex items-center justify-between gap-3">
            ...
            <a href="{{ route('groups.show', $group) }}" class="px-4 py-2 text-sm rounded-lg border border-gray-200 text-gray-700 hover:bg-gray-50">
                بازگشت به گروه
            </a>
        </div>

        <div class="p-6 space-y-6 text-sm leading-7 text-gray-700">
            <section>
