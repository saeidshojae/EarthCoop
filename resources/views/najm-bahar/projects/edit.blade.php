...
@section('title', 'ویرایش پروژه - نجم بهار')

@section('content')
<div class="container mx-auto px-4 py-8" dir="rtl">
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900">ویرایش پروژه</h1>
        <p class="text-gray-600 mt-2">در صورت نیاز اطلاعات پروژه را اصلاح کنید. تمام بخش‌های مشخص شده با * الزامی است.</p>
    </div>
    ...
    <form method="POST" action="{{ route('najm-bahar.projects.update', $project) }}" enctype="multipart/form-data" class="bg-white rounded-lg shadow">
        @csrf
        @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="project_type" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        ...
                        <option value="production" {{ old('project_type', $project->project_type) === 'production' ? 'selected' : '' }}>تولیدی</option>
                        <option value="service" {{ old('project_type', $project->project_type) === 'service' ? 'selected' : '' }}>خدماتی</option>
                        <option value="infrastructure" {{ old('project_type', $project->project_type) === 'infrastructure' ? 'selected' : '' }}>زیرساخت</option>
                        <option value="research" {{ old('project_type', $project->project_type) === 'research' ? 'selected' : '' }}>تحقیقی</option>
                        <option value="social" {{ old('project_type', $project->project_type) === 'social' ? 'selected' : '' }}>اجتماعی</option>
                    </select>
                ...
                <div>
                    ...
                    <select name="project_visibility" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        <option value="">انتخاب کنید</option>
                        <option value="public" {{ old('project_visibility', $project->project_visibility) === 'public' ? 'selected' : '' }}>عمومی</option>
                        <option value="private" {{ old('project_visibility', $project->project_visibility) === 'private' ? 'selected' : '' }}>خصوصی</option>
                    </select>
                ...
                <div>
                    ...
                    <select name="project_stage" id="project_stage" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        <option value="">انتخاب کنید</option>
                        <option value="idea" {{ old('project_stage', $project->project_stage) === 'idea' ? 'selected' : '' }}>ایده</option>
                        <option value="documented" {{ old('project_stage', $project->project_stage) === 'documented' ? 'selected' : '' }}>مستند‌شده</option>
                        <option value="prototype" {{ old('project_stage', $project->project_stage) === 'prototype' ? 'selected' : '' }}>نمونه‌سازی</option>
                        <option value="active" {{ old('project_stage', $project->project_stage) === 'active' ? 'selected' : '' }}>فعال</option>
                    </select>
        ...
        <div class="p-6 border-b border-gray-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div>
                    ...
                    <select name="category_level1_id" id="category_level1" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        ...
                        @foreach($categories as $category)
                            <option value="{{ $category->id }}" {{ old('category_level1_id', $project->category_level1_id) == $category->id ? 'selected' : '' }}>
                                {{ $category->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <select name="category_level2_id" id="category_level2" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <option value="">انتخاب کنید</option>
                        @if($project->categoryLevel2)
                            <option value="{{ $project->category_level2_id }}" selected>{{ $project->categoryLevel2->name }}</option>
                        @endif
                    </select>
                ...
                <div>
                    ...
                    <select name="category_level3_id" id="category_level3" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <option value="">انتخاب کنید</option>
                        @if($project->categoryLevel3)
                            <option value="{{ $project->category_level3_id }}" selected>{{ $project->categoryLevel3->name }}</option>
                        @endif
                    </select>
            ...
            <div id="existing_assets_section" style="display: none;">
                ...
                <textarea name="existing_assets" rows="3" 
                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="مثلاً: تجهیزات، فضا، تیم متخصص، ...">{{ old('existing_assets', $project->existing_assets) }}</textarea>
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <textarea name="problem_statement" rows="4" 
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        required>{{ old('problem_statement', $project->problem_statement) }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="solution_description" rows="4" 
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        required>{{ old('solution_description', $project->solution_description) }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="value_proposition" rows="3" 
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        placeholder="مثلاً: کاهش هزینه 30٪، بهبود کیفیت، ...">{{ old('value_proposition', $project->value_proposition) }}</textarea>
                ...
                <div>
                    ...
                    <select name="target_market" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        <option value="">انتخاب کنید</option>
                        <option value="local" {{ old('target_market', $project->target_market) === 'local' ? 'selected' : '' }}>محلی</option>
                        <option value="professional" {{ old('target_market', $project->target_market) === 'professional' ? 'selected' : '' }}>حرفه‌ای</option>
                        <option value="general" {{ old('target_market', $project->target_market) === 'general' ? 'selected' : '' }}>عمومی</option>
                        <option value="external" {{ old('target_market', $project->target_market) === 'external' ? 'selected' : '' }}>بین‌المللی</option>
                    </select>
            ...
            <div id="geographic-scope-section" class="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                ...
                <div id="location-selects">
                    ...
                    <div class="level-container mb-4">
                        ...
                        <select id="geographic_continent_select" name="geographic_continent_id" class="location-select w-full px-3 py-2 border border-gray-300 rounded-md" data-level="1" value="{{ old('geographic_continent_id', $project->geographic_continent_id) }}">
                            <option value="">انتخاب کنید</option>
                        </select>
            ...
            <div class="space-y-4">
                <label class="flex items-start gap-4 p-4 border-2 border-gray-300 rounded-lg cursor-pointer hover:bg-blue-50 transition-colors" id="method-auction-label">
                    <input type="radio" name="investment_method" value="auction_shares" 
                        ...
                        {{ old('investment_method', $project->investment_method ?? 'capital_participation') === 'auction_shares' ? 'checked' : '' }}>
                    <div class="flex-1">
                ...
                <label class="flex items-start gap-4 p-4 border-2 border-gray-300 rounded-lg cursor-pointer hover:bg-green-50 transition-colors" id="method-participation-label">
                    <input type="radio" name="investment_method" value="capital_participation" 
                        ...
                        {{ old('investment_method', $project->investment_method ?? 'capital_participation') === 'capital_participation' ? 'checked' : '' }}>
                    <div class="flex-1">
            ...
            <div class="investment-fields investment-auction" style="display: none;">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" name="base_value_min" value="{{ old('base_value_min', $project->base_value_min) }}" 
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                            min="1" step="1000">
                    ...
                    <div>
                        ...
                        <input type="number" name="base_value_max" value="{{ old('base_value_max', $project->base_value_max) }}" 
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                            min="1" step="1000">
            ...
            <div class="investment-fields investment-participation" style="display: none;">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" name="required_capital" value="{{ old('required_capital', $project->required_capital) }}" 
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                            min="1" step="1000">
                    ...
                    <div>
                        ...
                        <input type="number" name="profit_percentage" value="{{ old('profit_percentage', $project->profit_percentage) }}" 
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="number" name="investment_duration_months" value="{{ old('investment_duration_months', $project->investment_duration_months) }}" 
                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                            min="1">
        ...
        <div class="investment-fields investment-auction p-6 border-b border-gray-200" style="display: none;">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" name="total_shares" value="{{ old('total_shares', $project->total_shares ?? 100) }}" 
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        min="1">
                ...
                <div>
                    ...
                    <input type="number" name="initial_auction_percent" value="{{ old('initial_auction_percent', $project->initial_auction_percent ?? 30) }}" 
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <div>
                    ...
                    <input type="number" name="max_user_ownership_percent" value="{{ old('max_user_ownership_percent', $project->max_user_ownership_percent ?? 20) }}" 
                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <div>
                    ...
                    <select name="auction_period" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <option value="">انتخاب کنید</option>
                        <option value="monthly" {{ old('auction_period', $project->auction_period) === 'monthly' ? 'selected' : '' }}>ماهیانه</option>
                        <option value="quarterly" {{ old('auction_period', $project->auction_period) === 'quarterly' ? 'selected' : '' }}>فصلی</option>
                        <option value="semi_annual" {{ old('auction_period', $project->auction_period) === 'semi_annual' ? 'selected' : '' }}>نیم‌ساله</option>
                        <option value="annual" {{ old('auction_period', $project->auction_period) === 'annual' ? 'selected' : '' }}>سالانه</option>
                    </select>
        ...
        <div class="p-6 border-b border-gray-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <select name="risk_level" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        <option value="">انتخاب کنید</option>
                        <option value="low" {{ old('risk_level', $project->risk_level) === 'low' ? 'selected' : '' }}>کم</option>
                        <option value="medium" {{ old('risk_level', $project->risk_level) === 'medium' ? 'selected' : '' }}>متوسط</option>
                        <option value="high" {{ old('risk_level', $project->risk_level) === 'high' ? 'selected' : '' }}>زیاد</option>
                    </select>
                ...
                <div>
                    ...
                    <select name="oversight_type" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        <option value="">انتخاب کنید</option>
                        <option value="guild" {{ old('oversight_type', $project->oversight_type) === 'guild' ? 'selected' : '' }}>نظارت در صنف</option>
                        <option value="insurance" {{ old('oversight_type', $project->oversight_type) === 'insurance' ? 'selected' : '' }}>بیمه</option>
                        <option value="both" {{ old('oversight_type', $project->oversight_type) === 'both' ? 'selected' : '' }}>هر دو</option>
                        <option value="none" {{ old('oversight_type', $project->oversight_type) === 'none' ? 'selected' : '' }}>بدون نظارت خاص</option>
                    </select>
            ...
            <div>
                ...
                <textarea name="main_risks" rows="4" 
                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="ریسک ۱&#10;ریسک ۲&#10;ریسک ۳">{{ old('main_risks', $project->main_risks ? join("\n", $project->main_risks) : '') }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <select name="reporting_interval" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        <option value="">انتخاب کنید</option>
                        <option value="monthly" {{ old('reporting_interval', $project->reporting_interval) === 'monthly' ? 'selected' : '' }}>ماهیانه</option>
                        <option value="quarterly" {{ old('reporting_interval', $project->reporting_interval) === 'quarterly' ? 'selected' : '' }}>فصلی</option>
                        <option value="semi_annual" {{ old('reporting_interval', $project->reporting_interval) === 'semi_annual' ? 'selected' : '' }}>نیم‌ساله</option>
                        <option value="annual" {{ old('reporting_interval', $project->reporting_interval) === 'annual' ? 'selected' : '' }}>سالانه</option>
                    </select>
            ...
            <div class="border border-yellow-200 bg-yellow-50 rounded-md p-4 mb-6">
                <label class="flex items-start gap-3">
                    <input type="checkbox" name="accept_transparency" value="1" 
                        {{ old('accept_transparency', $project->accept_transparency) ? 'checked' : '' }} 
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <select name="failure_policy" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        <option value="">انتخاب کنید</option>
                        <option value="refund" {{ old('failure_policy', $project->failure_policy) === 'refund' ? 'selected' : '' }}>بازپرداخت</option>
                        <option value="asset_conversion" {{ old('failure_policy', $project->failure_policy) === 'asset_conversion' ? 'selected' : '' }}>تبدیل به دارایی</option>
                        <option value="vote" {{ old('failure_policy', $project->failure_policy) === 'vote' ? 'selected' : '' }}>رای‌گیری بین سرمایه‌گذاران</option>
                    </select>
                ...
                <div>
                    ...
                    <select name="value_update_trigger" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                        <option value="">انتخاب کنید</option>
                        <option value="stage_progress" {{ old('value_update_trigger', $project->value_update_trigger) === 'stage_progress' ? 'selected' : '' }}>پیشرفت مراحل</option>
                        <option value="oversight_approval" {{ old('value_update_trigger', $project->value_update_trigger) === 'oversight_approval' ? 'selected' : '' }}>تایید نظارت</option>
                    </select>
            ...
            <div class="border border-red-200 bg-red-50 rounded-md p-4">
                <label class="flex items-start gap-3">
                    <input type="checkbox" name="accept_rules" value="1" 
                        {{ old('accept_rules', $project->accept_rules) ? 'checked' : '' }} 
        ...
        <div class="p-6 border-b border-gray-200">
            ...
            <div class="mb-6">
                ...
                <textarea name="summary" rows="4" 
                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="یک خلاصه مختصر از پروژه">{{ old('summary', $project->summary) }}</textarea>
            ...
            <div class="mb-6">
                ...
                <textarea name="description" rows="6" 
                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                    placeholder="توضیحات جزئی‌تر درباره پروژه">{{ old('description', $project->description) }}</textarea>
            ...
            <div>
                ...
                @if(!empty($project->attachments))
                    <div class="mt-3 text-sm text-gray-600">
                        <strong class="block mb-2">پیوست‌های موجود:</strong>
                        <ul class="list-disc pr-6">
                            @foreach($project->attachments as $file)
                                <li>{{ $file['original_name'] ?? $file['path'] ?? 'فایل' }}</li>
                            @endforeach
                        </ul>
                    </div>
                @endif
        ...
        <div class="p-6 bg-gray-50 border-t border-gray-200 flex gap-3">
            ...
            <a href="{{ route('najm-bahar.projects.show', $project) }}" class="px-6 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium rounded-md">
                بازگشت
            </a>
        </div>
    </form>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const oldLevel2 = "{{ old('category_level2_id', $project->category_level2_id) }}";
    const oldLevel3 = "{{ old('category_level3_id', $project->category_level3_id) }}";
    ...
    function initializeGeographicLocation() {
        ...
        const existingValue = '{{ old('geographic_continent_id', $project->geographic_continent_id ?? '') }}';
        ...
        fetch('/api/geographic/continents')
            ...
            .then(data => {
                ...
                data.forEach(continent => {
                    ...
                    if (continent.id == existingValue || (continent.id == 4 && !existingValue)) option.selected = true;
                    continentSelect.appendChild(option);
                });
                
                // If there's an existing value, load next levels
                if (existingValue) {
