...
@push('styles')
<style>
    .pcr-page{direction:rtl;color:#172033;padding:2rem 0 4rem}.pcr-wrap{width:min(1120px,calc(100% - 2rem));margin:auto}.pcr-hero{position:relative;overflow:hidden;border:1px solid rgba(16,185,129,.2);border-radius:28px;padding:3rem;background:linear-gradient(135deg,rgba(236,253,245,.97),rgba(239,246,255,.96));box-shadow:0 24px 70px rgba(15,23,42,.08)}.pcr-hero:after{content:"";position:absolute;width:260px;height:260px;border-radius:50%;background:rgba(59,130,246,.1);left:-80px;top:-100px}.pcr-kicker{display:inline-flex;gap:.55rem;align-items:center;padding:.45rem .85rem;border-radius:999px;background:#fff;color:#047857;font-weight:800;font-size:.86rem;border:1px solid rgba(16,185,129,.2)}.pcr-hero h1{font-size:clamp(1.8rem,4vw,3rem);font-weight:900;margin:1rem 0 .8rem;color:#0f172a;line-height:1.5}.pcr-lead{font-size:1.08rem;line-height:2.05;color:#475569;max-width:880px}.pcr-live{display:flex;gap:.7rem;align-items:flex-start;margin-top:1.35rem;padding:1rem 1.1rem;border-radius:16px;background:rgba(255,255,255,.84);border:1px solid rgba(16,185,129,.22);color:#334155;line-height:1.85}.pcr-live i{color:#10b981;margin-top:.25rem}.pcr-summary{display:grid;grid-template-columns:repeat(4,1fr);gap:12px;margin-top:1.35rem}.pcr-summary div{background:rgba(255,255,255,.82);border:1px solid rgba(148,163,184,.2);border-radius:16px;padding:1rem}.pcr-summary strong{display:block;color:#0f766e;margin-bottom:.25rem}.pcr-summary span{color:#64748b;font-size:.9rem;line-height:1.7}.pcr-layout{display:grid;grid-template-columns:260px minmax(0,1fr);gap:24px;margin-top:24px;align-items:start}.pcr-nav{position:sticky;top:18px;background:#fff;border:1px solid #e2e8f0;border-radius:20px;padding:1rem;box-shadow:0 12px 35px rgba(15,23,42,.05)}.pcr-nav a{display:block;text-decoration:none;color:#475569;padding:.62rem .75rem;border-radius:10px;font-size:.91rem}.pcr-nav a:hover{background:#ecfdf5;color:#047857}.pcr-content{display:grid;gap:18px}.pcr-card{background:#fff;border:1px solid #e2e8f0;border-radius:22px;padding:1.6rem 1.7rem;box-shadow:0 12px 35px rgba(15,23,42,.045);scroll-margin-top:20px}.pcr-card h2{font-size:1.35rem;font-weight:900;color:#0f172a;margin:0 0 .8rem}.pcr-card h3{font-size:1.05rem;font-weight:800;color:#0f766e;margin:1.2rem 0 .5rem}.pcr-card p,.pcr-card li{line-height:2;color:#475569}.pcr-card ul,.pcr-card ol{padding-right:1.3rem;margin:.5rem 0}.pcr-note{background:#f8fafc;border-right:4px solid #10b981;border-radius:14px;padding:1rem 1.1rem;margin:1rem 0;color:#334155;line-height:1.9}.pcr-warning{background:#fff7ed;border-right-color:#f59e0b}.pcr-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px;margin-top:1rem}.pcr-mini{padding:1rem;border:1px solid #e2e8f0;background:#f8fafc;border-radius:16px}.pcr-mini strong{display:block;color:#0f766e;margin-bottom:.35rem}.pcr-mini p{margin:0;font-size:.92rem}.pcr-tiers{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px;margin-top:1rem}.pcr-tier{padding:1rem;border-radius:16px;border:1px solid #e2e8f0;background:#fff;text-align:center}.pcr-tier strong{display:block;color:#0f172a;font-size:1rem}.pcr-tier span{display:block;color:#64748b;font-size:.84rem;margin-top:.35rem}.pcr-table-wrap{overflow-x:auto;border:1px solid #e2e8f0;border-radius:16px;margin-top:1rem}.pcr-table{width:100%;min-width:880px;border-collapse:collapse}.pcr-table th,.pcr-table td{padding:.75rem .8rem;border-bottom:1px solid #e2e8f0;text-align:right;vertical-align:top;line-height:1.75;font-size:.86rem}.pcr-table th{color:#0f766e;background:#f8fafc;font-weight:800;white-space:nowrap}.pcr-table tr:last-child td{border-bottom:0}.pcr-rule-name{font-weight:800;color:#0f172a}.pcr-rule-meta{display:block;color:#94a3b8;font-size:.74rem;margin-top:.2rem}.pcr-badge{display:inline-flex;align-items:center;gap:.3rem;padding:.25rem .55rem;border-radius:999px;font-size:.76rem;font-weight:800;white-space:nowrap}.pcr-badge--on{background:#ecfdf5;color:#047857}.pcr-badge--off{background:#f1f5f9;color:#64748b}.pcr-badge--warn{background:#fff7ed;color:#b45309}.pcr-badge--bad{background:#fef2f2;color:#b91c1c}.pcr-conversion{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px;margin:1rem 0}.pcr-stat{background:#f8fafc;border:1px solid #e2e8f0;border-radius:16px;padding:1rem}.pcr-stat strong{display:block;color:#047857;font-size:1.15rem;margin-bottom:.25rem}.pcr-stat span{color:#64748b;font-size:.84rem;line-height:1.7}.pcr-faq details{border-top:1px solid #e2e8f0;padding:.9rem 0}.pcr-faq details:first-child{border-top:0}.pcr-faq summary{cursor:pointer;font-weight:800;color:#0f172a}.pcr-faq p{margin:.55rem 0 0}.pcr-actions{display:flex;gap:10px;flex-wrap:wrap;margin-top:1.3rem}.pcr-btn{display:inline-flex;align-items:center;gap:.5rem;text-decoration:none;border-radius:12px;padding:.75rem 1rem;font-weight:800}.pcr-btn-primary{background:#10b981;color:#fff}.pcr-btn-soft{background:#fff;color:#0f766e;border:1px solid #a7f3d0}@media(max-width:900px){.pcr-summary{grid-template-columns:repeat(2,1fr)}.pcr-layout{grid-template-columns:1fr}.pcr-nav{position:static;display:flex;overflow:auto;gap:4px}.pcr-nav a{white-space:nowrap}.pcr-hero{padding:2rem}.pcr-tiers{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:640px){.pcr-page{padding-top:1rem}.pcr-wrap{width:min(100% - 1rem,1120px)}.pcr-hero{padding:1.4rem;border-radius:20px}.pcr-summary,.pcr-grid,.pcr-conversion,.pcr-tiers{grid-template-columns:1fr}.pcr-card{padding:1.2rem;border-radius:18px}.pcr-live{font-size:.9rem}.pcr-table th,.pcr-table td{padding:.65rem}.pcr-actions{display:grid}.pcr-btn{justify-content:center}}
</style>
@endpush
