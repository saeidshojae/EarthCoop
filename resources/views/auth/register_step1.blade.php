        ...
        <div class="text-center mb-4 sm:mb-6 md:mb-8">
            ...
            <div class="flex items-center justify-center gap-2 sm:gap-3 md:gap-4 mb-2 sm:mb-4 step-indicator-container">
                ...
                <div class="flex items-center flex-col sm:flex-row">
                    ...
                    <span class="mr-0 sm:mr-2 mt-1 sm:mt-0 text-xs sm:text-sm text-gray-400 hidden sm:inline">ØµÙ†ÙÛŒ</span>
            ...
            <div class="bg-red-50 border-r-4 border-red-500 text-red-800 px-3 sm:px-4 md:px-6 py-3 sm:py-4 rounded-lg mb-4 sm:mb-6 shadow-md">
                ...
                <div class="flex items-start">
                    ...
                    <div class="mr-2 sm:mr-3 flex-1">
                        ...
                        <h3 class="text-base sm:text-lg font-bold mb-2 text-red-800">Ù„Ø·ÙØ§Ù‹ Ø®Ø·Ø§Ù‡Ø§ÛŒ Ø²ÛŒØ± Ø±Ø§ Ø§ØµÙ„Ø§Ø­ Ú©Ù†ÛŒØ¯:</h3>
            ...
            <form id="step1-form" action="{{ route('register.step1.process') }}" method="POST" class="space-y-4 sm:space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="first_name" name="first_name" value="{{ old('first_name') }}" required
                           ...
                           placeholder="Ù†Ø§Ù… Ø®ÙˆØ¯ Ø±Ø§ Ø¨Ù‡ ÙØ§Ø±Ø³ÛŒ ÙˆØ§Ø±Ø¯ Ú©Ù†ÛŒØ¯">
                ...
                <div>
                    ...
                    <input type="text" id="last_name" name="last_name" value="{{ old('last_name') }}" required
                           ...
                           placeholder="Ù†Ø§Ù… Ø®Ø§Ù†ÙˆØ§Ø¯Ú¯ÛŒ Ø®ÙˆØ¯ Ø±Ø§ Ø¨Ù‡ ÙØ§Ø±Ø³ÛŒ ÙˆØ§Ø±Ø¯ Ú©Ù†ÛŒØ¯">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-3 gap-2 sm:gap-3 md:gap-4">
                        ...
                        <select name="birth_date[]" required class="px-2 sm:px-3 md:px-4 py-2 sm:py-3 text-sm sm:text-base border rounded-lg focus:ring-2 focus:ring-ocean-blue transition @error('birth_date') border-red-500 bg-red-50 @else border-gray-300 @enderror">
                            ...
                            @php $months = ['ÙØ±ÙˆØ±Ø¯ÛŒÙ†', 'Ø§Ø±Ø¯ÛŒØ¨Ù‡Ø´Øª', 'Ø®Ø±Ø¯Ø§Ø¯', 'ØªÛŒØ±', 'Ù…Ø±Ø¯Ø§Ø¯', 'Ø´Ù‡Ø±ÛŒÙˆØ±', 'Ù…Ù‡Ø±', 'Ø¢Ø¨Ø§Ù†', 'Ø¢Ø°Ø±', 'Ø¯ÛŒ', 'Ø¨Ù‡Ù…Ù†', 'Ø§Ø³ÙÙ†Ø¯']; @endphp
                    ...
                    <div class="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
                        ...
                        <div class="bg-gray-50 rounded-lg p-3 sm:p-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                                ...
                                <div>
                                    ...
                                    <label class="text-sm font-bold text-gray-600 block mb-1">Ø´Ù…Ø§Ø±Ù‡ ØªÙ„ÙÙ†:</label>
                        ...
                        <div class="bg-blue-50 border-r-4 border-blue-500 p-3 sm:p-4 rounded-lg">
                            ...
                            <p class="text-xs sm:text-sm text-blue-800">
                                ...
                                Ù„Ø·ÙØ§Ù‹ Ø§Ø·Ù„Ø§Ø¹Ø§Øª Ø¨Ø§Ù„Ø§ Ø±Ø§ Ø¨Ø±Ø±Ø³ÛŒ Ú©Ù†ÛŒØ¯. Ø¯Ø± ØµÙˆØ±Øª ØµØ­ØªØŒ Ø±ÙˆÛŒ Ø¯Ú©Ù…Ù‡ "ØªØ£ÛŒÛŒØ¯ Ùˆ Ø§Ø¯Ø§Ù…Ù‡" Ú©Ù„ÛŒÚ© Ú©Ù†ÛŒØ¯.
    ...
    <script>
        ...
        document.getElementById('submit-btn').addEventListener('click', function(e) {
            ...
            .catch(error => {
                ...
                alert('Ø®Ø·Ø§ÛŒÛŒ Ø±Ø® Ø¯Ø§Ø¯. Ù„Ø·ÙØ§Ù‹ Ø¯ÙˆØ¨Ø§Ø±Ù‡ ØªÙ„Ø§Ø´ Ú©Ù†ÛŒØ¯.');
    ...
    <div id="congratulations-modal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        ...
        <div class="bg-white rounded-2xl shadow-2xl max-w-md mx-auto p-8 text-center" style="animation: fadeIn 0.5s ease-out;">
            ...
            <h2 class="text-3xl font-extrabold text-gentle-black mb-4" style="color: var(--color-gentle-black);">
                ...
                ØªØ¨Ø±ÛŒÚ© Ù…ÛŒâ€ŒÚ¯ÙˆÛŒÛŒÙ…! ðŸŽ‰
            ...
            <p class="text-lg text-gray-700 mb-6 leading-relaxed">
                ...
                Ø³Ù‡Ø§Ù…Ø¯Ø§Ø± Ø¹Ø²ÛŒØ²ØŒ Ø´Ù…Ø§ Ø¨Ø§ Ù…ÙˆÙÙ‚ÛŒØª Ø¨Ù‡ <span class="font-bold" style="color: var(--color-earth-green);">EarthCoop</span> Ù¾ÛŒÙˆØ³ØªÛŒØ¯. 
            ...
            <p class="text-base text-gray-600 mb-6 leading-relaxed">
                ...
                Ù„Ø·ÙØ§ Ø¯Ù‚Ø§ÛŒÙ‚ÛŒ ÙˆÙ‚Øª Ø¨Ú¯Ø°Ø§Ø±ÛŒØ¯ Ùˆ Ø¯Ø± <span class="font-bold">Ø³Ù‡ Ù…Ø±Ø­Ù„Ù‡</span> Ø§Ø·Ù„Ø§Ø¹Ø§Øª Ù‡ÙˆÛŒØªÛŒØŒ ØµÙ†ÙÛŒ Ùˆ Ù…Ú©Ø§Ù†ÛŒ Ø®ÙˆØ¯ Ø±Ø§ ÙˆØ§Ø±Ø¯ Ú©Ù†ÛŒØ¯.
