...
<head>
    ...
    <title>ØªØ£ÛŒÛŒØ¯ Ø§ÛŒÙ…ÛŒÙ„ - EarthCoop</title>
    ...
    <style>
        ...
        * { font-family: 'Vazirmatn', 'Poppins', sans-serif; }
        ...
        .verification-code input {
            ...
            direction: ltr; /* Ú©Ø¯ Ø§Ø² Ú†Ù¾ Ø¨Ù‡ Ø±Ø§Ø³Øª ÙˆØ§Ø±Ø¯ Ø´ÙˆØ¯ */

            text-align: center; /* Ù…ØªÙ† Ø¯Ø± Ù…Ø±Ú©Ø² Ø¨Ø§Ø´Ø¯ */
    ...
    <div class="form-card-gradient w-full max-w-2xl mx-auto p-8 md:p-10">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-lg text-gray-600">
                ...
                Ú©Ø¯ ØªØ£ÛŒÛŒØ¯ Ø¨Ù‡ Ø§ÛŒÙ…ÛŒÙ„ Ø´Ù…Ø§ Ø§Ø±Ø³Ø§Ù„ Ø´Ø¯Ù‡ Ø§Ø³Øª. Ù„Ø·ÙØ§Ù‹ Ú©Ø¯ Ø±Ø§ ÙˆØ§Ø±Ø¯ Ú©Ù†ÛŒØ¯:
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    inputs.forEach((input, index) => {
        ...
        // ØªÙ†Ø¸ÛŒÙ… direction Ø¨Ø±Ø§ÛŒ Ù‡Ø± input
        ...
        input.addEventListener('keydown', function(e) {
            ...
            if (e.key === 'Backspace' && this.value === '') {
                ...
                if (index > 0) {
                    ...
                    inputs[index - 1].value = ''; // Ù¾Ø§Ú© Ú©Ø±Ø¯Ù† Ù…Ù‚Ø¯Ø§Ø± Ù‚Ø¨Ù„ÛŒ
        ...
        // Handle paste - Ø¨Ø±Ø§ÛŒ Ú©Ù¾ÛŒ Ú©Ø±Ø¯Ù† Ú©Ø¯ Ú©Ø§Ù…Ù„
    ...
    function updateTimer() {
        ...
        if (remaining > 0) {
            ...
            timerDisplay.innerHTML = `<i class="fas fa-clock ml-1"></i> Ø§Ù…Ú©Ø§Ù† Ø§Ø±Ø³Ø§Ù„ Ù…Ø¬Ø¯Ø¯ ØªØ§ ${minutes}:${seconds.toString().padStart(2, '0')} Ø¯ÛŒÚ¯Ø± ÙØ¹Ø§Ù„ Ù…ÛŒâ€ŒØ´ÙˆØ¯.`;
