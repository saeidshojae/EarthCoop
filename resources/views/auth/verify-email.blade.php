...
<head>
    ...
    <style>
        ...
        * { font-family: 'Vazirmatn', 'Poppins', sans-serif; }
        ...
        /* ===== دکمه تأیید – اصلاح شده ===== */
        .btn-primary-custom {
            background-color: var(--color-earth-green); /* رنگ پس‌زمینه یکدست به‌عنوان fallback */
            background-image: linear-gradient(135deg, var(--color-earth-green) 0%, var(--color-dark-green) 100%);
            color: white;
            font-weight: 700;
