...
<head>
    ...
    <title>Ù…Ø±Ø­Ù„Ù‡ Û³ - Ø§Ø·Ù„Ø§Ø¹Ø§Øª Ù…Ú©Ø§Ù†ÛŒ</title>
...
<body class="font-vazirmatn leading-relaxed flex items-center justify-center min-h-screen p-0 sm:p-2 md:p-4">
    ...
    <div class="form-card-gradient w-full max-w-3xl mx-auto p-4 sm:p-6 md:p-8 lg:p-10">
        ...
        <div class="text-center mb-4 sm:mb-6 md:mb-8">
            ...
            <div class="flex items-center justify-center flex-wrap gap-2 sm:gap-3 md:gap-4 mb-2 sm:mb-4">
                ...
                <div class="flex items-center flex-col sm:flex-row opacity-50">
                    ...
                    <span class="mr-0 sm:mr-2 mt-1 sm:mt-0 text-xs sm:text-sm text-gray-500 hidden sm:inline">Ù‡ÙˆÛŒØªÛŒ</span>
                ...
                <div class="flex items-center flex-col sm:flex-row opacity-50">
                    ...
                    <span class="mr-0 sm:mr-2 mt-1 sm:mt-0 text-xs sm:text-sm text-gray-500 hidden sm:inline">ØµÙ†ÙÛŒ</span>
                ...
                <div class="flex items-center flex-col sm:flex-row">
                    ...
                    <div class="w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center font-bold text-white text-sm sm:text-base" style="background-color: var(--color-ocean-blue);">Û³</div>

                    <span class="mr-0 sm:mr-2 mt-1 sm:mt-0 text-xs sm:text-sm font-bold hidden sm:inline" style="color: var(--color-ocean-blue);">Ù…Ú©Ø§Ù†ÛŒ</span>
        ...
        <div class="text-right">
            ...
            <h2 class="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-extrabold text-gentle-black mb-3 sm:mb-4" style="color: var(--color-gentle-black);">
                ...
                Ù…Ø±Ø­Ù„Ù‡ Û³: Ø§Ø·Ù„Ø§Ø¹Ø§Øª Ù…Ú©Ø§Ù†ÛŒ

            </h2>

            <p class="text-gray-600 mb-4 sm:mb-6 text-xs sm:text-sm md:text-base">

                Ù„Ø·ÙØ§ Ù…Ú©Ø§Ù† Ø®ÙˆØ¯ Ø±Ø§ Ø¨Ø§ Ø¯Ù‚Øª Ø§Ù†ØªØ®Ø§Ø¨ Ù†Ù…Ø§ÛŒÛŒØ¯. Ø§Ø² Ø§ÛŒÙ† Ø§Ø·Ù„Ø§Ø¹Ø§Øª Ø¨Ø±Ø§ÛŒ Ú¯Ø±ÙˆÙ‡â€ŒØ¨Ù†Ø¯ÛŒ Ù…Ú©Ø§Ù†ÛŒ Ø´Ù…Ø§ Ø§Ø³ØªÙØ§Ø¯Ù‡ Ù…ÛŒâ€ŒØ´ÙˆØ¯.

                <span class="text-red-600 font-bold">ÙˆØ§Ø±Ø¯ Ú©Ø±Ø¯Ù† Ø§Ø·Ù„Ø§Ø¹Ø§Øª ØªØ§ Ø³Ø·Ø­ Ù…Ø­Ù„Ù‡ Ø§Ù„Ø²Ø§Ù…ÛŒ Ø§Ø³Øª.</span>
            ...
            <div class="location-path text-center" id="location_path_display">
                ...
                <span>Ù…Ø³ÛŒØ± Ø§Ù†ØªØ®Ø§Ø¨ Ù†Ø´Ø¯Ù‡</span>
    ...
    <div id="createLocationModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4">
        ...
        <div class="bg-white rounded-xl sm:rounded-2xl shadow-2xl max-w-md mx-auto p-4 sm:p-6 md:p-8 w-full">
            ...
            <h3 class="text-lg sm:text-xl md:text-2xl font-bold text-gentle-black mb-4 sm:mb-6" style="color: var(--color-gentle-black);">
                ...
                Ø§ÛŒØ¬Ø§Ø¯ <span id="modal_location_type"></span> Ø¬Ø¯ÛŒØ¯
            ...
            <form id="createLocationForm">
                ...
                <div class="mb-4 sm:mb-6">
                    ...
                    <label for="location_name" class="block text-sm sm:text-base md:text-lg font-bold text-gray-800 mb-2 sm:mb-3">
                        ...
                        Ù†Ø§Ù… <span id="modal_location_type_label"></span>:
                ...
                <div id="create_location_error" class="hidden bg-red-100 text-red-700 px-3 sm:px-4 py-2 rounded-lg mb-3 sm:mb-4 text-xs sm:text-sm">
                    ...
                    Ø®Ø·Ø§ Ø¯Ø± Ø«Ø¨Øª Ø§Ø·Ù„Ø§Ø¹Ø§Øª. Ù„Ø·ÙØ§Ù‹ Ø¯ÙˆØ¨Ø§Ø±Ù‡ ØªÙ„Ø§Ø´ Ú©Ù†ÛŒØ¯.
    ...
    <script>
        ...
        const levelLabels = ['Ù‚Ø§Ø±Ù‡', 'Ú©Ø´ÙˆØ±', 'Ø§Ø³ØªØ§Ù†', 'Ø´Ù‡Ø±Ø³ØªØ§Ù†', 'Ø¨Ø®Ø´', 'Ø´Ù‡Ø± / Ø¯Ù‡Ø³ØªØ§Ù†', 'Ù…Ù†Ø·Ù‚Ù‡/ Ø±ÙˆØ³ØªØ§', 'Ù…Ø­Ù„Ù‡', 'Ø®ÛŒØ§Ø¨Ø§Ù†', 'Ú©ÙˆÚ†Ù‡'];
        ...
        const optionalLevels = [9, 10]; // Ø®ÛŒØ§Ø¨Ø§Ù† Ùˆ Ú©ÙˆÚ†Ù‡ Ø§Ø®ØªÛŒØ§Ø±ÛŒ Ù‡Ø³ØªÙ†Ø¯

        const defaultContinentId = '4'; // Ø¢Ø³ÛŒØ§

        const defaultCountryId = '74'; // Ø§ÛŒØ±Ø§Ù†
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.create-location-btn', function() {
                ...
                if (!parentId) {
                    ...
                    alert('Ù„Ø·ÙØ§Ù‹ Ø§Ø¨ØªØ¯Ø§ Ø³Ø·Ø­ Ù‚Ø¨Ù„ÛŒ Ø±Ø§ Ø§Ù†ØªØ®Ø§Ø¨ Ú©Ù†ÛŒØ¯ØŒ Ø³Ù¾Ø³ Ú¯Ø²ÛŒÙ†Ù‡ Ø¬Ø¯ÛŒØ¯ Ø±Ø§ Ø§ÛŒØ¬Ø§Ø¯ Ù†Ù…Ø§ÛŒÛŒØ¯.');
        ...
        function initializeDefaultPath() {
            ...
            const resolvedContinent = continentText || 'Ø¢Ø³ÛŒØ§';
        ...
        function loadNextLevel(parentId, level) {
            ...
            const showLabel = isOptional ? `${label} (Ø§Ø®ØªÛŒØ§Ø±ÛŒ)` : label;
        ...
        function getIconForLevel(level) {
            ...
            const icons = [
                ...
                'fas fa-globe',          // Ù‚Ø§Ø±Ù‡

                'fas fa-flag',           // Ú©Ø´ÙˆØ±

                'fas fa-map',            // Ø§Ø³ØªØ§Ù†

                'fas fa-city',           // Ø´Ù‡Ø±Ø³ØªØ§Ù†

                'fas fa-building',       // Ø¨Ø®Ø´

                'fas fa-home',           // Ø´Ù‡Ø±

                'fas fa-map-marked-alt', // Ù…Ù†Ø·Ù‚Ù‡

                'fas fa-map-pin',        // Ù…Ø­Ù„Ù‡

                'fas fa-road',           // Ø®ÛŒØ§Ø¨Ø§Ù†

                'fas fa-route'           // Ú©ÙˆÚ†Ù‡
        ...
        function updatePathDisplay() {
            ...
            const display = [
                ...
                `<span data-level="0" data-value="world"><i class="fas fa-globe-asia ml-1"></i>Ø²Ù…ÛŒÙ†</span>`,
            ...
            $('#location_path_display').html(display || '<i class="fas fa-map-marker-alt ml-2"></i><span>Ù…Ø³ÛŒØ± Ø§Ù†ØªØ®Ø§Ø¨ Ù†Ø´Ø¯Ù‡</span>');
        ...
        function updateSubmitButtonState() {
            ...
            const neighborhoodId = pathValues[7]; // Ù…Ø­Ù„Ù‡ = Ø³Ø·Ø­ 8
        ...
        function resetToContinent() {
            ...
            // Ø­Ø°Ù ØªÙ…Ø§Ù… Ù…Ù†ÙˆÙ‡Ø§ÛŒ Ø¯ÛŒÚ¯Ø±
