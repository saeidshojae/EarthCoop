...
<aside class="admin-sidebar" 
    ...
    <div class="p-6 border-b border-gray-700">
        <div class="flex items-center justify-between">
            <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-3 space-x-reverse">
                ...
                <div>
                    <span class="text-white font-bold text-lg">EarthCoop</span>
                    <p class="text-gray-400 text-xs">مدیریت سیستم</p>
                </div>
            </a>
    ...
    <nav class="p-4">
        <ul class="space-y-1">
            ...
            <li>
                <a href="{{ route('admin.najm-hoda.index') }}" 
                   class="flex items-center space-x-3 space-x-reverse px-4 py-3 rounded-lg text-white hover:bg-gray-700 transition-colors {{ request()->routeIs('admin.najm-hoda.*') ? 'bg-gray-700' : '' }}">
                    ...
                    <span>نجم‌هدا</span>
                    @php
                        $waitingChats = \Illuminate\Support\Facades\Schema::hasTable('support_chats')
                            ? \App\Models\SupportChat::where('status', 'waiting')->count()
                            : 0;
                    @endphp
                    @if($waitingChats > 0)
            ...
            <!-- ========================================== -->
            <!-- 3. Najm Bahar (نجم بهار) -->
            <!-- ========================================== -->
            <li>
                <a href="{{ route('admin.najm-bahar.dashboard') }}"
                   class="flex items-center space-x-3 space-x-reverse px-4 py-3 rounded-lg text-white hover:bg-gray-700 transition-colors {{ request()->routeIs('admin.najm-bahar.*') ? 'bg-gray-700' : '' }}">
            ...
            <!-- ========================================== -->
            <!-- 5. Roles & Permissions (نقش‌ها و دسترسی‌ها) -->
            <!-- ========================================== -->
            ...
            <!-- ========================================== -->
            <!-- 7. System Settings (تنظیمات سیستمی) -->
            <!-- ========================================== -->
            <li>
            ...
            <!-- ========================================== -->
            <!-- 9. Activation Management (مدیریت فعال‌سازی‌ها) -->
            <!-- ========================================== -->
            <li>
            ...
            <!-- ========================================== -->
            <!-- 10. Content Management (مدیریت محتوا) -->
            <!-- ========================================== -->
            ...
            <!-- ========================================== -->
            <!-- 13. Knowledge Base (پایگاه دانش) - زیرمنو -->
            <!-- ========================================== -->
            ...
            <!-- ========================================== -->
            <!-- 15. Email Management (مدیریت ایمیل) - زیرمنو -->
            <!-- ========================================== -->
