...
<aside class="admin-sidebar" 
    ...
    <nav class="p-4">
        <ul class="space-y-1">
            ...
            <li><a href="{{ route('admin.location-governance.index') }}" class="flex items-center space-x-3 space-x-reverse px-4 py-3 rounded-lg text-white hover:bg-gray-700 transition-colors {{ request()->routeIs('admin.location-governance.*') ? 'bg-gray-700' : '' }}"><i class="fas fa-map-marked-alt w-5"></i><span>مکان و حکمرانی</span></a></li>
