...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    ...
    <style>
        ...
        /* Custom Tailwind Configuration - Ù¾ÛŒÚ©Ø±Ø¨Ù†Ø¯ÛŒ Ø±Ù†Ú¯â€ŒÙ‡Ø§ Ùˆ ÙÙˆÙ†Øªâ€ŒÙ‡Ø§ */
        ...
        .font-vazirmatn { 
            ...
            font-display: swap; /* Ø¨Ù‡Ø¨ÙˆØ¯ Ù„ÙˆØ¯ ÙÙˆÙ†Øª */
        ...
        /* ÙÙˆØ±ÛŒ: ØªÙ†Ø¸ÛŒÙ… Ø§Ù†Ø¯Ø§Ø²Ù‡ Ù¾Ø§ÛŒÙ‡ Ø¨Ø±Ø§ÛŒ Edge */
        ...
        /* ØªÙ†Ø¸ÛŒÙ… Ø§Ù†Ø¯Ø§Ø²Ù‡ ÙÙˆÙ†Øªâ€ŒÙ‡Ø§ Ø¨Ø±Ø§ÛŒ Edge */
    ...
    <div class="bg-white rounded-3xl shadow-2xl max-w-md w-full transform transition-all duration-300 scale-95 opacity-0" id="modalContent">
        ...
        <div class="relative bg-gradient-to-br from-earth-green to-ocean-blue text-white p-6 rounded-t-3xl">
            ...
            <div class="text-center">
                ...
                <p class="text-sm mt-2 opacity-90 font-vazirmatn">Ø¨Ø±Ø§ÛŒ Ø´Ø±ÙˆØ¹ Ø¹Ø¶ÙˆÛŒØªØŒ Ù„Ø·ÙØ§Ù‹ Ø§Ø·Ù„Ø§Ø¹Ø§Øª Ø²ÛŒØ± Ø±Ø§ ØªÚ©Ù…ÛŒÙ„ Ú©Ù†ÛŒØ¯</p>
                ...
                <div class="mb-6">
                    ...
                    <div class="bg-blue-50 border-r-4 border-ocean-blue p-4 rounded-lg mb-4">
                        ...
                        <p class="text-sm text-gray-700 font-vazirmatn">
                            ...
                            Ø¯Ø± Ø­Ø§Ù„ Ø­Ø§Ø¶Ø± Ø«Ø¨Øªâ€ŒÙ†Ø§Ù… ÙÙ‚Ø· Ø¨Ø§ Ú©Ø¯ Ø¯Ø¹ÙˆØª Ø§Ù…Ú©Ø§Ù†â€ŒÙ¾Ø°ÛŒØ± Ø§Ø³Øª
                    ...
                    <label class="flex items-start cursor-pointer">
                        ...
                        <span class="mr-3 text-sm text-gray-700 font-vazirmatn leading-relaxed">
                            ...
                            <a href="javascript:void(0)" onclick="openTerms()" class="text-ocean-blue hover:text-blue-700 font-semibold underline">
                                ...
                                Ø§Ø³Ø§Ø³Ù†Ø§Ù…Ù‡ Ùˆ Ø´Ø±Ø§ÛŒØ· Ø§Ø³ØªÙØ§Ø¯Ù‡
        ...
        sections.forEach(section => {
            ...
            if (section && section.nodeType === 1) {
                ...
                try {
                    ...
                    // Ø§Ú¯Ø± observe Ø®Ø·Ø§ Ø¯Ø§Ø¯ØŒ ÙÙ‚Ø· class Ø±Ø§ Ø§Ø¶Ø§ÙÙ‡ Ú©Ù†
            ...
            if (isEdge) {
                ...
                setTimeout(function() {
                    ...
                    if (!tailwindWorks || document.documentElement.classList.contains('tailwind-fallback')) {
                        ...
                        // Ø§Ø¹Ù…Ø§Ù„ ÙÙˆØ±ÛŒ Ø§Ø³ØªØ§ÛŒÙ„â€ŒÙ‡Ø§ÛŒ fallback
                        ...
                        // ÙÙ‚Ø· Ø¯Ø± development Ù„Ø§Ú¯ Ú©Ù†
