...
<head>
    ...
    <title>Ø®Ø·Ø§ÛŒ Ø³Ø±ÙˆØ± - EarthCoop</title>
        ...
        <div class="container mx-auto max-w-2xl">
            ...
            <div class="bg-white rounded-2xl shadow-2xl p-8 md:p-12 text-center fade-in">
                ...
                <p class="text-lg md:text-xl text-gray-600 mb-8 leading-relaxed">
                    ...
                    Ù…ØªØ£Ø³ÙØ§Ù†Ù‡ Ø®Ø·Ø§ÛŒÛŒ Ø¯Ø± Ø³Ø±ÙˆØ± Ø±Ø® Ø¯Ø§Ø¯Ù‡ Ø§Ø³Øª. ØªÛŒÙ… ÙÙ†ÛŒ Ù…Ø§ Ø¯Ø± Ø­Ø§Ù„ Ø¨Ø±Ø±Ø³ÛŒ Ù…Ø´Ú©Ù„ Ø§Ø³Øª. Ù„Ø·ÙØ§Ù‹ Ú†Ù†Ø¯ Ù„Ø­Ø¸Ù‡ ØµØ¨Ø± Ú©Ù†ÛŒØ¯ Ùˆ Ø¯ÙˆØ¨Ø§Ø±Ù‡ ØªÙ„Ø§Ø´ Ú©Ù†ÛŒØ¯.
                ...
                <div class="bg-gray-50 rounded-xl p-6 mb-8 text-right">
                    ...
                    <ul class="space-y-3 text-gray-700">
                        ...
                        <li class="flex items-start">
                            ...
                            <span>Ø¨Ù‡ <strong>ØµÙØ­Ù‡ Ø§ØµÙ„ÛŒ</strong> Ø¨Ø±Ú¯Ø±Ø¯ÛŒØ¯</span>
                        ...
                        <li class="flex items-start">
                            ...
                            <span>Ø§Ú¯Ø± Ù…Ø´Ú©Ù„ Ø§Ø¯Ø§Ù…Ù‡ Ø¯Ø§Ø´ØªØŒ Ø¨Ø§ <strong>Ù¾Ø´ØªÛŒØ¨Ø§Ù†ÛŒ</strong> ØªÙ…Ø§Ø³ Ø¨Ú¯ÛŒØ±ÛŒØ¯</span>
