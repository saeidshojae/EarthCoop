...
return [
    ...
    'domains' => [
        ...
        'secretariat' => ['label'=>'Secretariat & Correspondence','priority'=>10,'integration_stage'=>'mapped','risk'=>'medium','sources'=>['secretariat module','knowledge files'],'event_prefixes'=>['najm_hoda.input.secretariat.'],'capabilities'=>['observe','propose']],
        'najm_bahar' => ['label'=>'Najm Bahar Finance','priority'=>10,'integration_stage'=>'mapped','risk'=>'high','sources'=>['NajmBahar models','transactions','projects','salary runs'],'event_prefixes'=>['najm_hoda.input.najm_bahar.'],'capabilities'=>['observe']],
        ...
        'blog' => ['label'=>'Blog & Editorial Operations','priority'=>8,'integration_stage'=>'observed','risk'=>'medium','sources'=>['app/Modules/Blog','blog posts','comments','categories','tags'],'event_prefixes'=>['najm_hoda.input.blog.'],'capabilities'=>['observe']],
        'stock' => ['label'=>'Stock, Auctions & Settlement','priority'=>10,'integration_stage'=>'observed','risk'=>'high','sources'=>['app/Modules/Stock','auctions','settlement','share ownership'],'event_prefixes'=>['najm_hoda.input.stock.'],'capabilities'=>['observe']],
        'content' => ['label'=>'Pages, Knowledge Base & Published Content','priority'=>7,'integration_stage'=>'mapped','risk'=>'medium','sources'=>['pages','kb_articles','faq_questions','content observers'],'event_prefixes'=>['najm_hoda.input.content.'],'capabilities'=>['observe']],
