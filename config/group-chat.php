...
return [
    ...
    */
    ...
    'features' => [
        ...
        'api_envelope_v1' => env('GROUP_CHAT_FEATURE_API_ENVELOPE_V1', true),
        'idempotency_v1' => env('GROUP_CHAT_FEATURE_IDEMPOTENCY_V1', true),
        'message_lifecycle_v1' => env('GROUP_CHAT_FEATURE_MESSAGE_LIFECYCLE_V1', true),
        'feed_sequence_v1' => env('GROUP_CHAT_FEATURE_FEED_SEQUENCE_V1', false),
        'feed_unread_v1' => env('GROUP_CHAT_FEATURE_FEED_UNREAD_V1', false),
        'transactional_outbox_v1' => env('GROUP_CHAT_FEATURE_TRANSACTIONAL_OUTBOX_V1', false),
        'realtime_envelope_v1' => env('GROUP_CHAT_FEATURE_REALTIME_ENVELOPE_V1', false),
        'delta_sync_v1' => env('GROUP_CHAT_FEATURE_DELTA_SYNC_V1', false),
        'modular_frontend_v1' => env('GROUP_CHAT_FEATURE_MODULAR_FRONTEND_V1', false),
    ],
];
